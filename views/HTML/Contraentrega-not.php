...
<body>
    ...
    <h3 id="l1">PROCESAR PAGO CONTRAENTREGA</h3>
        ...
        <div class="Bloque1">
          <div class="metcard">
            ...
            <ul class="lists">
              ...
              <span class="mettitle2">Pagas $70.000</span>
            <!-- Botón para continuar con este método de pago -->
            <button onclick="pedido()" class="action">Alquilar</button>
          </div>
        </div>
